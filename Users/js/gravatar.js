...
function getGravatar (email, size) { // MD5 (Message-Digest Algorithm) by WebToolkit
    ...
    size = size || 80
        return `https://www.gravatar.com/avatar/${ MD5(email) }.jpg?s=${ size }&d=404`
  }
//actualizar Gravatar
function getUserEmail(){
  ...
  .then(email=>{
    $(document).ready(function(){
        try {
            var avatarImage= '<img src="' + getGravatar(email, 100) + '" />'; 
